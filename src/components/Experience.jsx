...
import NYITImage from '../assets/nyitfullcolor.png';
...
const experiences = [
	...
	},
	{
		...
		description:
			'Over the course of my time in Liquid Studio, I have presented around 10+ demos of different varients to clients, MDs, and other groups. This time period was spent learning about the different demos in the lab oriented towards training myself on the demos within the space and how to present them.',
		image: demoImage,
	},
	{
		...
		description:
			'Led the software team for my FIRST Robotics Team 1796, the RoboTigers. Led a team of 5 students to program the entire robot. Also have presented to 30+ students on advanced programming concepts and created videos on learning software development skills that has acruued 5.5k views ',
...
const Experience = () => (
	<>
		<section
			...
			className="bg-gradient-to-bl from-blue-900 to-gray-900 text-white py-12 px-4 md:px-8"
		>
